...
<body>
    <form id="form1" runat="server">
        ...
        <div class="center-page">
            ...
            <div class="col-xs-11">
            <asp:TextBox ID="tblpassword" runat="server" Class="form-control" placeholder="username" TextMode="Password"></asp:TextBox>
            </div>

              <label class="col-xs-11">Confirm Password</label>
            <div class="col-xs-11">
            <asp:TextBox ID="tblconfirm" runat="server" Class="form-control" placeholder="username" TextMode="Password"></asp:TextBox>
            </div>


             <label class="col-xs-11">E-mail</label>
            <div class="col-xs-11">
            <asp:TextBox ID="tblmail" runat="server" Class="form-control" placeholder="username" TextMode="Email"></asp:TextBox>
            </div>
